...
class EmdadgarTextThemeExtension
    extends ThemeExtension<EmdadgarTextThemeExtension> {
  ...
  factory EmdadgarTextThemeExtension.light() => EmdadgarTextThemeExtension(
  ...
  @override
  ThemeExtension<EmdadgarTextThemeExtension> lerp(
      EmdadgarTextThemeExtension? other, double t) {
    if (other is! EmdadgarTextThemeExtension) return this;
    return EmdadgarTextThemeExtension.light();
  }

  @override
  EmdadgarTextThemeExtension copyWith({
    ...
    return EmdadgarTextThemeExtension(
