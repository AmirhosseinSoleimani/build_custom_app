...
extension StringExtension on String {
  ...
  Widget imageWidget({Color? color,double? width,double? height,BoxFit? boxFit, required String package}) => ImageWidget(path: this,color: color,width: width,height: height, boxFit: boxFit, package: package,);
}
